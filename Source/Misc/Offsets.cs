namespace Offsets
{
    ...
    public struct GameObject
    {
        ...
        public const uint IsActive = 0x56;
    ...
    public struct Exfil
    {
        public const uint Status = 0xA8; // [C0] _status : System.Byte
    ...
    {
        public const uint MovementContext = 0x50; //[50] <MovementContext>k__BackingField : EFT.MovementContext //For offline raids
        public const uint Corpse = 0x3F8; //     [3F8] Corpse : EFT.Interactive.Corpse
    ...
    public struct ObservedPlayerView // [Class] EFT.NextObservedPlayer.ObservedPlayerView : MonoBehaviour
    {
        ...
        public const uint IsAI = 0x108; // bool
        ...
        public static readonly uint[] To_MovementContext = new uint[] { ObservedPlayerController, 0xC8, 0x10 }; // to MovementContext ///For online raids
    ...
    public struct ObservedPlayerMovementContext // [Class] -.CMovementContext : Object, GInterfaceAC99 from [Class] -.CPlayerController : Object, GInterfaceAC49, IDisposable From [Class] EFT.NextObservedPlayer.ObservedPlayerView : MonoBehaviour, IPlayer
    {
        public const uint Rotation = 0x88; //     [88] vector2_0x88 : UnityEngine.Vector2
    }
    ...
    {
        public const uint MongoID = 0x50; // string,unity
    ...
    public struct ProceduralWeaponAnimation
    {
        ...
        public const uint FirearmController = 0xA8; //[A8] _firearmController : -.Player.FirearmController
    ...
    public struct FirearmController
    {
        ...
        public const uint Fireport = 0xD0; //[D0] Fireport : EFT.BifacialTransform
    }
    ...
    {
        public const uint MapName = 0x50; //[50] string_0x48 : String
        public const uint MainPlayer = 0x140; // to EFT.Player //mainplayer
        public const uint ExfilController = 0x20; // to ExfilController
        public const uint LootList = 0xC0; // [C0] LootList to UnityList
    ...
    {
        public const uint ItemOwner = 0x118; //[118] ItemOwner : -.GClass
